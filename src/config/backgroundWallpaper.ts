...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		mobile: [
			"assets/images/MobileWallpaper/pixiv1.jpg",
			//"assets/images/MobileWallpaper/m2.avif",
		...
		playerUrl: "https://img.coccineus.uk/file/1787400253967_DECO＊27_-_DECO＊27_-_テレパシ_feat._初音ミク.webm",
	},
	// 横幅壁纸和全屏壁纸共享配置
	common: {
			...
			links: [
				{
					...
					url: "https://github.com/Azure144",
					showName: true,
				},
				{
					name: "Email",
					icon: "fa7-solid:envelope",
					url: "mailto:auphanim@outlook.com",
				},
				{
					name: "Sponsor",
					icon: "material-symbols:favorite",
					url: "https://coccineus.uk/sponsor/",
				},
				{
					name: "RSS",
					icon: "fa7-solid:rss",
